...
{image:https://tiefleta.sirv.com/Polish_20221001_152952867.png?text.0.text=$getUserVar[captchacode]&text.0.position.gravity=south&text.0.position.x=3%25&text.0.position.y=-25%25&text.0.size=70&text.0.color=3CB979&text.0.opacity=59}};{actionRow:
